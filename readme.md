# Person Marking in South-Central Trans-Himalayan: Biate

This PARALEX set contains person markers in Biate, including inflected verbal forms and pronouns. It constitutes part of the PMST (Person Marking in South-Central Trans-Himalayan) database.
...
## Additional information specific to Biate

* Tone: Biate has two contrastive tones: high and low. Preliminary observations suggest that both tones may also be realized as a falling contour. However, tonal information is not included in this database since the analysis of the tonal system is still in its early stages.
* Mapping between database paradigm labels and Biate descriptive labels:
Database label = Language-specific descriptive label
fut.aff = future affirmative
fut.neg = future negative
nfut.aff = nonfuture affirmative
nfut.neg = nonfuture negative
